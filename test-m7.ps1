# test-m7.ps1 - boots headless and prints the M7 (ext2) markers.
...
Write-Host '=== M7 / ext2 markers ==='
Get-Content $log -ErrorAction SilentlyContinue |
    Select-String -Pattern 'M8|M7|ext2|M6|FAT32|vfs|fstest|user exited|PANIC|EXCEPTION|DOUBLE' |
